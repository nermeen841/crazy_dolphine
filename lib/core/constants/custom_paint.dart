...
class DottedBorderImage extends CustomPainter {
  final int numberOfStories;
  final int spaceLength;
  double startOfArcInDegree = 0;

  DottedBorderImage({required this.numberOfStories, this.spaceLength = 10});
  double inRads(double degree) {
    return (degree * pi) / 180;
  }

  @override
  bool shouldRepaint(DottedBorderImage oldDelegate) {
    return true;
  }
